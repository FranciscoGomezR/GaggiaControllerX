...
void fcn_initSsrController(struct_ssrController * ptr_instance)
{
    ...
    tempPidCtrl.P_TERM_CTRL           = ACTIVE;
    tempPidCtrl.I_TERM_CTRL           = ACTIVE;
    tempPidCtrl.D_TERM_CTRL           = ACTIVE;
    tempPidCtrl.D_TERM_LP_FILTER_CTRL = ACTIVE;
}
